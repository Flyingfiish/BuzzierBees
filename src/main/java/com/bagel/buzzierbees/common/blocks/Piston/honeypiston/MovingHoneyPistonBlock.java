...
public class MovingHoneyPistonBlock extends ContainerBlock {
   public static final DirectionProperty FACING = PistonHeadBlock.FACING;
   public static final EnumProperty<PistonType> TYPE = PistonHeadBlock.TYPE;

   public MovingHoneyPistonBlock(Properties properties) {
      super(properties);
   ...
   public static TileEntity createTilePiston(BlockState p_196343_0_, Direction p_196343_1_, boolean p_196343_2_, boolean p_196343_3_) {
      return new HoneyPistonTileEntity(p_196343_0_, p_196343_1_, p_196343_2_, p_196343_3_);
   }
   ...
   public void onReplaced(BlockState state, World worldIn, BlockPos pos, BlockState newState, boolean isMoving) {
      if (state.getBlock() != newState.getBlock()) {
         ...
         if (tileentity instanceof HoneyPistonTileEntity) {
            ((HoneyPistonTileEntity)tileentity).clearPistonTileEntity();
         }
   ...
   public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
      HoneyPistonTileEntity pistontileentity = this.func_220170_a(builder.getWorld(), builder.assertPresent(LootParameters.POSITION));
   ...
   public VoxelShape getCollisionShape(BlockState state, IBlockReader worldIn, BlockPos pos, ISelectionContext context) {
      HoneyPistonTileEntity pistontileentity = this.func_220170_a(worldIn, pos);
      return pistontileentity != null ? pistontileentity.getCollisionShape(worldIn, pos) : VoxelShapes.empty();
   }

   @Nullable
   private HoneyPistonTileEntity func_220170_a(IBlockReader p_220170_1_, BlockPos p_220170_2_) {
      TileEntity tileentity = p_220170_1_.getTileEntity(p_220170_2_);
      return tileentity instanceof HoneyPistonTileEntity ? (HoneyPistonTileEntity)tileentity : null;
   }
